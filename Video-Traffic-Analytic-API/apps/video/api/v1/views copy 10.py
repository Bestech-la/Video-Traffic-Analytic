    ...
    def perform_create(self, serializer):
        ...
        if video_file:
            ...
            while True:
                ...
                cv2.line(frame, (0, red_line_y), (frame.shape[1], red_line_y), (0, 255, 255), 2)
                ...
                for (x, y, w, h) in cars:
                    if y + h > red_line_y:
                        ...
                        if car_id not in captured_car_plates:
                            ...
                            detect_and_crop_car_plate(img_path_car, output_cropped_path_blue, lower_blue, upper_blue, 'blue')
                            ...
                            # detect_and_crop_car_plate(img_path_car, output_cropped_path_red, lower_red, upper_red, 'red')
                            
                            # lower_yellow = np.array([20, 100, 100])
                            # upper_yellow = np.array([30, 255, 255])
                            # output_cropped_path_yellow = f'captured_images/yellow_1_car_plate_{str(len(os.listdir("captured_images")) + 1)}.png'
                            # detect_and_crop_car_plate(img_path_car, output_cropped_path_yellow, lower_yellow, upper_yellow, 'yellow')
...
#             # Check if the detected contour has a certain aspect ratio
#             aspect_ratio = w / h
...
#             else:
#                 print(f"{color_name.capitalize()} car plate not detected. Invalid aspect ratio.")
#         else:
